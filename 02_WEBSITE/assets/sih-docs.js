(() => {
  const documents = {
    ...
    '01_SIH_6_SLIDE_SUBMISSION_CONTENT.md': 'Six-slide submission content',
    '02_TEAM_BRIEFING_AND_EXECUTION_ROADMAP.md': 'Team briefing and roadmap',
    '03_ROLES_AND_DAILY_PLAN.md': 'Roles and daily plan',
    '04_SIH_SCOPE_AND_INDUSTRY_MENTORING_MODEL.md': 'Scope and mentoring model',
    '06_TEAM_WORKFLOW_AND_PRESENTATION_SCRIPT.md': 'Workflow and presentation script',
  };
  ...
  source.href = `../resources/${encodeURIComponent(current)}`;
  ...
  fetch(`../resources/${encodeURIComponent(current)}`).then(response => {
    ...
    document.title = `${documents[current]} | Apollo SIH`;
